...
/**
 * Configuration du cache Redis des taux de change.
 *
 * Les taux sont mémorisés 24 h pour éviter d'appeler le fournisseur externe à
 * chaque conversion. La sérialisation JSON est configurée explicitement : voir
